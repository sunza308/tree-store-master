...
import kotlinx.android.synthetic.main.activity_edit_user.txtName
import kotlinx.android.synthetic.main.activity_edit_user.txtPassword
import kotlinx.android.synthetic.main.activity_edit_user.txtUsername
...
class editUser : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        supportActionBar!!.title = "แก้ไขข้อมูลสมาชิก"
    ...
    private fun onPostEditUser() {
        ...
        disposable = service.register(txtUsername.text.toString(), txtPassword.text.toString(), txtName.text.toString(), txtTel.text.toString(), txtFb.text.toString())
            ...
            .subscribe(
                { result ->
                    if (result.code == 200) {
                        Toast.makeText(this, "แก้ไขข้อมูลสมาชิกเรียบร้อยแล้ว", Toast.LENGTH_SHORT).show()
                    } else {
